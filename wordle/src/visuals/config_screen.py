...
def generate_buttons():
    ...
    for i, llm in enumerate(["openai", "openrouter", "gemini", "grok", "ollama"]):
        buttons.append(Button(pygame.Rect(
            100 + (total_width / 5 + 2) * i,
            600, total_width / 5 - 6, cell_width
...
def config_screen(game: 'GameState', **kwargs):
    ...
    llm_buttons: list[Button] = kwargs['buttons'][10:15] 
    play_button: Button = kwargs['buttons'][15]
